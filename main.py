...
# 화면 타이틀 설정
pygame.display.set_caption("NCOC Pang")
...
# 배경 만들기
background = pygame.image.load("./game_image/background.jpg")

# 스테이지 만들기
stage = pygame.image.load("./game_image/stage.PNG")
stage_size = stage.get_rect().size
stage_height = stage_size[1] # 스테이지의 높이 위에 캐릭터를 두기 위해 사용

# 캐릭터 만들기
character = pygame.image.load("./game_image/haedol2.jpeg")
...
# 무기 만들기
weapon = pygame.image.load("./game_image/weapon.png")
...
ball_images = [
    pygame.image.load("./game_image/IPScan1.png"),
    pygame.image.load("./game_image/IPScan2.png"),
    pygame.image.load("./game_image/IPScan3.png"),
    pygame.image.load("./game_image/IPScan4.png")]
